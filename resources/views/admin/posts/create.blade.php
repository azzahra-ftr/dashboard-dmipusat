...
@section('content')
    <div class="container">
        <h2 class="judul-halaman">Add New Berita</h2>
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="judul" class="form-control custom-input" required
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="summernote" name="isi_berita" class="form-control"></textarea>
                    </div>
            ...
            <div class="card card-upload-gambar">
                ...
                <div class="card-footer text-center">
                    <button type="submit" class="btn btn-submit">Unggah</button>
                </div>
        </form>
    </div>
@endsection     
